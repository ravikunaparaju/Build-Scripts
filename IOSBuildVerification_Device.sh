...
xcodebuild -target app-cal -configuration Debug -sdk iphoneos8.2
...
ruby ~/code/os-maps-automation/buildscripts/transporter_chief.rb ~/$path_to_device_buildApp/app-cal.app
